-- OWNER 0.2 - P5
-- Inbox notifiche e preferenze in-app, esclusivamente ambiente TEST.
...
BEGIN
    IF current_database() <> 'stima360_db_test' THEN
        RAISE EXCEPTION 'OWNER 0.2 P5 bloccata: database corrente %, atteso stima360_db_test', current_database();
    END IF;
